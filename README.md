...
- Empower people to think about their local budgets
- Reimagine the impact of the money we are putting into the police.

## Features

- Interactive graph shows city department budgets compared to the police budget
- Users adjust the budget amount on the graph
- Send/tweet proposed budget to user's local representative or mayor
